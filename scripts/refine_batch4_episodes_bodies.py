...
BATCH4_EPISODES: dict[str, dict[str, dict[str, Any]]] = {
    ...
    "tzs-ep176": {
        ...
        "zh": {
            ...
            "golden_quotes": [
                "Story 和 Style 让你进门；Spirit 和 Social 让你第二次买。",
                "十五年教会你哪些角色一季就死——4S 是我们过滤他们的办法。",
                "盲盒是社交仪式——没有 Social，你就是在卖塑料。",
            ],
            "chronology": {
                "subject": "陈灰常 · 泡泡玛特 4S",
                "events": [
    ...
    "tzs-ep167": {
        ...
        "zh": {
            ...
            "golden_quotes": [
                "茅台卖的是稀缺——每多一层经销商都是对故事的征税。",
                "拼多多补贴能动瓶，但烧的是双方都要的高端叙事。",
                "看批价，别看 headline 收入——渠道先讲真话。",
            ],
            "chronology": {
                "subject": "杜基阁 · 茅台渠道改革",
                "events": [
